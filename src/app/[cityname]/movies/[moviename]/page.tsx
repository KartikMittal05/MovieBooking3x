...
const MoviePage = () => {
    ...
    const movie = {
        ...
        potraitposter: "https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/jawan-et00330424-1693892482.jpg",
        title: "Jawan",
        rating: 8.5,
        halls: [
            "2D",
    ...
    return (
        <div className='moviepage'>
            ...
            <div className="c2">
                ...
                <div className="line"></div>
                <h1>Crew</h1>
                <div className="circlecardslider"> <Swiper
                        slidesPerView={1}
                        spaceBetween={1}
                        pagination={{
                            clickable: true,
